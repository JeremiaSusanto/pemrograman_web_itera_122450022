...
export function demoVariables(){
    ...
    {
        var oldVar = "Changes inside block";
    }

    let newLet = "New let variable";
    {
        let newLet = "Different variable inside block";
        console.log("newLet inside block:", newLet); // Output: Different variable inside block
    }
